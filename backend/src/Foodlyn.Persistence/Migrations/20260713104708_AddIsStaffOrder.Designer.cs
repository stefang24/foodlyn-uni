...
namespace Foodlyn.Persistence.Migrations
{
    ...
    [Migration("20260713104708_AddIsStaffOrder")]
    partial class AddIsStaffOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foodlyn.Modules.Notifications.Domain.Entities.Notification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Foodlyn.Modules.Ordering.Domain.Entities.TableSession", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Foodlyn.Modules.Ordering.Domain.Entities.TableSessionCartLine", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("AddedByLabel")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("AddedBySessionId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.HasIndex("TableSessionId", "LineKey");

                    b.ToTable("table_session_cart_lines", (string)null);
                });

            modelBuilder.Entity("Foodlyn.Modules.Ordering.Domain.Entities.TableSessionCartLineModifier", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("TableSessionCartLineId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TableSessionCartLineId");

                    b.ToTable("table_session_cart_line_modifiers", (string)null);
                });
            ...
            modelBuilder.Entity("Foodlyn.Modules.Ordering.Domain.Entities.TableSessionCartLine", b =>
                {
                    b.HasOne("Foodlyn.Modules.Ordering.Domain.Entities.TableSession", "Session")
                        .WithMany("CartLines")
            ...
            modelBuilder.Entity("Foodlyn.Modules.Ordering.Domain.Entities.TableSessionCartLineModifier", b =>
                {
                    b.HasOne("Foodlyn.Modules.Ordering.Domain.Entities.TableSessionCartLine", "Line")
                        .WithMany("Modifiers")
                        .HasForeignKey("TableSessionCartLineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
